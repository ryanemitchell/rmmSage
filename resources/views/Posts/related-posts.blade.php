...
<div class="flex flex-col justify-center w-full md:flex-row featuredPosts">'
		...
		@foreach($relatedPosts as $relatedPost)
				...
				<a href="@permalink($relatedPost->ID)" class="flex items-center mr-9 font-bold border-r-2 border-secondary only:border-none only:mr-0 last-of-type:border-none last-of-type:mr-0 lg:h-12">
