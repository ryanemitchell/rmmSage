...
<section class="flex relative justify-center items-center place-items-center rmmsection full-width to-the-edge bg-hulk-800 my-halfMobileVGap lg:my-halfDesktopVGap {{$className}} {{$mobileDisplay}} {{$desktopDisplay}}">
