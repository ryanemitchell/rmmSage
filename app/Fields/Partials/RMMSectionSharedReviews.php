...
class RMMSectionSharedReviews extends Partial
{
    /**
    ...
    {
        $rmmSectionSharedReviews = new FieldsBuilder('rmmSection_shared_reviews');

        $rmmSectionSharedReviews

            ->addGroup('rmmSectionSharedReviews', [ 'label' => ''])
	        ...
	        ->addMessage('message_field', 'message', [
		        ...
		        'message' => 'This section\'s content is edited in the "Wit Sections > Reviews Section" Menu',
        ...
        return $rmmSectionSharedReviews;
    }
}
