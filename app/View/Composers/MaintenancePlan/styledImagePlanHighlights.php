...
class styledImagePlanHighlights extends Composer
{
    /**
	...
	public function with()
	{
		...
		$sectionName =  'styledimageplanhighlights'; // ** Lowercase even if defined differently
...
//			Repeater
			'highlights' 	 => ( new RmmSageFunctions() )->rmmGetFields( $fieldGroupName . $sectionName )['highlights'],
