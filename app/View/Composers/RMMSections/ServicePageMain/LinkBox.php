...
class LinkBox extends Composer
{
    /**
    ...
    {
        if (!empty(get_field('SectionMainServicesSection_group')['sectionDisplay'])) {
            return get_field('SectionMainServicesSection_group')['sectionDisplay'];
        } else {
            return [];
        }
    }
...
//    {
//        return get_field('SectionMainServicesSection_group')['sectionStyling'];
//    }
    ...
    {
        return get_field('SectionMainServicesSection_group');
    }
    ...
    {
        if (!empty(get_field('SectionMainServicesSection_group', $id)['sectionContent'])) {
            return get_field('SectionMainServicesSection_group', $id)['sectionContent'];
        } else {
            return [];
        }
    }
